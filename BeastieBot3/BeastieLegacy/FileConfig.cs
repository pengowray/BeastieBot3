...
namespace beastie {
	public class FileConfig {
        ...
        //TODO2025: replace hardcoded paths with config file / PathsService

        //http://www.iucnredlist.org/about/summary-statistics#Table_9
        public static string datadir = @"d:\datasets\";
        public static string coredata = @"d:\datasets\beastie-reports\";
