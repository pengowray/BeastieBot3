            ...
            Steps = new[] {
                ...
                new FlowStep {
                    ...
                    GuideSteps = new[] {
                        ...
                        "Save both zips, still zipped, in a folder named for the release, for example D:\\datasets\\IUCN_CVS_2026-1, with each download in its own subfolder. The release version must appear somewhere in that path: the import reads \"2026-1\" from the folder name, not from the zip contents.",
