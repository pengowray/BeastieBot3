        ...
        new FlowDefinition {
            ...
            Steps = new[] {
                ...
                new FlowStep {
                    ...
                    Commands = new[] { "wikipedia fetch-pages", "wikidata cache-entities --failed-only" },
                    ...
                    Note = "Failed pages sit at the front of the Wikipedia queue, so an ordinary fetch retries them before anything else. For Wikidata, --failed-only goes straight to them. A page recorded as missing is a different thing: English Wikipedia has no article under that title, and re-running will not change that.",
                },
                new FlowStep {
                    Id = "wiki-refresh",
